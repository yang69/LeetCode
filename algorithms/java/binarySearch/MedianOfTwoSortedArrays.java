...
public class MedianOfTwoSortedArrays {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(medianOfTwoSortedArrays.findMedianSortedArrays(new int[]{1}, new int[]{2}) + " <---> 1.5");
        System.out.println(medianOfTwoSortedArrays.findMedianSortedArrays(new int[]{1,3}, new int[]{2}) + " <---> 2.0");
        System.out.println(medianOfTwoSortedArrays.findMedianSortedArrays(new int[]{1,2,3}, new int[]{5}) + " <---> 2.5");
    }
}
